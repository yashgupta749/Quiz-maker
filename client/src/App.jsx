...
class App extends Component {
  ...
  checkLogin = () => {
    return sessionStorage.getItem("quiz-isLoggedIn") === "LOGGED_IN";
  };
  ...
  handleLogin = (response) => {
    this.setState({
      ...
      user: { ...response },
      authToken: sessionStorage.getItem("quiz-authToken"),
    });
    sessionStorage.setItem("quiz-isLoggedIn", "LOGGED_IN");
  };
  ...
  handleLogout = (event) => {
    ...
    sessionStorage.setItem("quiz-isLoggedIn", "");
    sessionStorage.setItem("quiz-authToken", "");
  };
